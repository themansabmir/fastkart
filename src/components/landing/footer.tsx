    ...
    <footer className="bg-foreground text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <a href="/" className="inline-flex items-center gap-2 mb-4 cursor-pointer hover:opacity-80 transition-opacity">
            ...
            <div className="flex gap-3">
              <a href="#" className="h-9 w-9 rounded-full bg-white/10 hover:bg-primary flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#tracking" className="text-gray-400 hover:text-primary transition-colors">Track Parcel</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Prohibited Items</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Insurance Claims</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2 text-gray-400">
                ...
                <span>support@nationwidecourier.in</span>
              </li>
            </ul>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-sm text-gray-400">
          <p>© {currentYear} Nationwide Courier Pvt. Ltd. All rights reserved. | Registered office: Mumbai, India</p>
